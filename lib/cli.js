...
module.exports = async (argv) => {
  program
    ...
    .option('-z, --temp-directory <dirPath>', 'denote a custom location for temp frame images to be saved (default is OS temp directories)')
    .parse(argv)
  ...
  try {
    ...
    await concat({
      ...
      tempFramesDir: program.tempDirectory
    })
